                    ...
                    <div className="card-body text-start mt-3">
                      ...
                      <div className="mt-4">
                        ...
                        <div className="course-list">
                          ...
                          <div className="course-item ">
                            <span className="fw-bold">
                              Types of detailed mehendi as in mandala, Floral
                              pattern
                            </span>
                          </div>
                          <div className="course-item">
                          ...
                          <div className="course-item">
                            <span className="fw-bold">
                              Bride Groom with proportions demonstration on
                              hands
                            </span>
                          </div>
                        </div>
                  ...
                  <div className="card">
                    ...
                    <div className="row mt-4">
                      ...
                      <div className="col-10 mt-2">
                        <span>Paramita Garani</span>
                        <br />
                        <span className="text-muted ms-0"> Mehendi artist</span>
                      </div>
                    </div>

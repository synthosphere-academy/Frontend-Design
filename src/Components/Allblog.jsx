...
export const Allblog = () => {
  ...
  const memoizedBlogData = useMemo(() => allblogdata, [allblogdata]);
            ...
            <div className="card-body">
              ...
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html: blogdata.shortdescription,
                }}
              ></p>
            </div>
          </div>
  ...
  return (
    <>
      ...
      <p className="text-center fw-bold">
        Explore an array of captivating blogs on technology, science, arts, and
        more, offering valuable insights and knowledge for curious minds to
        delve into.
      </p>
      <div className="container py-5">
        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 ">
          {memoizedBlogData.map(redercoursecard)}
        </div>
      </div>
    </>
  );

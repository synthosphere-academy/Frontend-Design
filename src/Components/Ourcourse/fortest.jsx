 {/* 3rd */}
                ...
                <div className="card h-100 d-flex flex-column comingcard">
                  ...
                  <div className="card-body flex-grow-1">
                    ...
                    <div>
                      ...
                      <br />
                      <b>⭐ Timings: Flexible, as per your choice</b>
                      <br />
                      <b>⭐Seat Booking: ₹1,000/-</b>
                      <br />
                      ...
                      <br />
                      ⭐Bride Groom with proportions demonstration on hands
                      <br />
                    </div>
                    <br />
                    <b>
                ...
                <div className="card h-100 d-flex flex-column comingcard">
                  ...
                  <div className="card-body flex-grow-1">
                    ...
                    <div>
                      <b>⭐⭐ Next Batch will start from : July</b>
                      <br />
                      <b>⭐ Duration: 3 months course (Weekly 1 class)</b>
                      <br />
                      <b>⭐ ISO certification</b>
                      <br />
                      <h5 className="fw-bold mt-3">🌟Course details</h5>
                      <div className="d-flex">
                        <div>
                          <ul className="list-unstyled ps-3">
                            ...
                            <li>
                              ⭐How to charge, cleanse and store tarot cards
                            </li>
                            <li>
              ...
              <div>
                <div className="card h-100 d-flex flex-column comingcard">
                  ...
                  />
                  <div className="card-body flex-grow-1">
                    <h3 className="mt-1 fw-bold">The Advance Makeup Course</h3>
                    <div className="d-flex justify-content-between">
                      <span
                        className="starreview ms-2"
                        style={{ color: "gold" }}
                    ...
                    <div>
                      <b>⭐⭐ Next Batch will start from : July</b>
                      <br />
                      <b>⭐ Duration: 16 Days (2days in a week),</b>
                      <br />
                      <b>⭐Time: 11a.m - 3p.m </b>
                      <br />

...
If you have any questions about these Terms, please contact us at info@synthosphereacademy.in.
        ...
        <div className='row'>
          <div className='col'><Link to="/register"><button className='backbutton'>Back</button></Link></div>
          {/* <div className='col text-end'><button className='backbutton'>Next</button></div> */}
        </div>
        </div>

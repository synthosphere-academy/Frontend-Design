                ...
                <div className="container">
                    <div className="row py-4">
                        ...
                        <div className="col-lg-4 me-auto text-center">
                            ...
                            <div>
                           <a href="mailto:support@synthosphereacademy.in"><i class="fa fa-envelope text-white" style={{fontSize:"19px"}}></i></a>
                            ...
                            <a href='https://www.instagram.com/synthosphere_academy?' target='_blank'><i class="fa fa-instagram ms-3 text-white"style={{fontSize:"19px"}} ></i></a>
                            </div>
                            </div>

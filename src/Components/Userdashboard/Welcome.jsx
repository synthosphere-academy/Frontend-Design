              ...
              <div ref={invoiceRef} className="invoice-desktop">
                <div className="card">
                        ...
                        <div className="col-lg-12">
                          <div className="container mt-4">
                            ...
                            <div className="row">
                              ...
                              <div className="col-lg-6 col-sm-12 udbhablogo"></div>
                            </div>
                            <p
                              style={{
                                textAlign: "justify",
                            ...
                            >
                              A Warm Welcome and Congratulations on Joining
                              Synthosphere Academy!
                              <br />
                              <br />
                              Dear, Sir/Madam <br />
                              On behalf of the entire team, we would like to
                              extend a heartfelt welcome to Synthosphere
                              Academy! We are absolutely thrilled to have you
                              join our community of aspiring and experienced
                              crypto enthusiasts. More importantly, we want to
                              offer our sincere congratulations on taking this
                              powerful step forward by investing in your
                              knowledge and future. By Enrollment the
                              Synthosphere Academy{" "}
                              {userDetails?.packageName || "course"}, you have
                              committed to mastering the complexities of the
                              cryptocurrency world, and we are here to support
                              you every step of the way. If you have any
                              questions during your onboarding process, please
                  ...
                  {orderdata
                    ...
                    .map((order, index) => (
                      <>
                        <div className="h4 fw-bold text-center mt-5">
                          Invoice
                        </div>
                            ...
                            <div>
                              ...
                              <div className="row mt-4">
                                <div className="col-md-4">
                                  ...
                                  <h4>₹ {Number(order.amount).toFixed(2)}</h4>
                                </div>
                                ...
                                <div className="col-md-4">
                                  <p className="text-secondary mb-1">PAID ON</p>
                                  <p>
                                    {new Date(
                                      order.createdAt,
                                    ).toLocaleDateString()}

    ...
    <div className="container">
      <div className="row justify-content-center">
        ...
        <div className="col-lg-8 col-12">
          ...
          <div className="fw-bold mb-4 d-none d-md-block text-center">
        ...
        <div className="fw-bold mb-4 d-block d-md-none video-title-mobile">
          <span className="user-id-badge mt-5">Get a certificate</span>
        </div>
      </div>
    </div>
  );

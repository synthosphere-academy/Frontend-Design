    ...
    <>
      ...
      {/* <Nav /> */}
       ...
       {/* course details */}
        ...
        {/* for p2p */}
        {/* <Route path='/deposit' element={<Userlayout><Depositform/></Userlayout>}/>
        <Route path='/sellordercreate' element={<Userlayout><Sellordercreate/></Userlayout>}/>
        <Route path='/buyordercreate' element={<Userlayout><Buyusdt/></Userlayout>}/>
        <Route path='/mybuyorders' element={<Userlayout><Mybuyorder/></Userlayout>}/>
        <Route path='/buyhistory' element={<Userlayout><Buyhistory/></Userlayout>}/>
        <Route path='/sellhistory' element={<Userlayout><Sellhistory/></Userlayout>}/>
        <Route path='/p2pdashboard' element={<Userlayout><P2pdashboard/></Userlayout>}/> */}
         {/* 404 page not found */}
